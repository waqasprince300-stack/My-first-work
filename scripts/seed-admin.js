...
const run = async () => {
  ...
  console.log(
    "Tip: use a dedicated super-admin email (not your day-to-day org admin), so that user can approve new administrators without losing business-admin API access.",
  );
  console.log(
    "Organization admins who sign up while a super admin exists will stay pending until approved in the app.",
  );
